  ...
  *********************************************************************/
  ...
  return (
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 md:inset-auto md:bottom-24 md:right-0 w-full md:w-[470px] h-[100%] md:h-[700px] bg-gradient-to-b from-[#00BF63] to-white rounded-none md:rounded-2xl shadow-xl border overflow-hidden flex flex-col z-50">
